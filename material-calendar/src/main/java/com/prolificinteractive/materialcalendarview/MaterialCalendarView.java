...
//            setRightArrowMask(rightMask);
    ...
    private void setupChildren() {
        ...
        addView(container, new LayoutParams(1));

        topbar = new LinearLayout(getContext());
        topbar.setOrientation(LinearLayout.HORIZONTAL);
        topbar.setClipChildren(false);
        topbar.setClipToPadding(false);
        container.addView(topbar, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT, 1));
        ...
        LinearLayout dividerBar = new LinearLayout(getContext());
        dividerBar.setOrientation(LinearLayout.VERTICAL);
        dividerBar.setClipChildren(false);
        dividerBar.setClipToPadding(false);
        container.addView(dividerBar, new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));

        View divider = new View(getContext());
        divider.setBackgroundColor(Color.WHITE);
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, 2);
        lp.setMargins(10, 5, 10, 0);

        dividerBar.addView(divider, lp);
