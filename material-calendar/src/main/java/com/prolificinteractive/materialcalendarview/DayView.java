...
class DayView extends CheckedTextView {
    ...
    public DayView(Context context, CalendarDay day) {
        ...
        selectionDrawable = getResources().getDrawable(R.drawable.date_pressed);
    ...
    private Drawable generateBackground(int color, int fadeTime) {
        StateListDrawable drawable = new StateListDrawable();
        drawable.setExitFadeDuration(fadeTime);
        drawable.addState(new int[]{android.R.attr.state_checked}, getResources().getDrawable(R.drawable.date_pressed));
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            drawable.addState(new int[] { android.R.attr.state_pressed }, getResources().getDrawable(R.drawable.date_pressed));
        } else {
            drawable.addState(new int[] { android.R.attr.state_pressed }, getResources().getDrawable(R.drawable.date_pressed));
        }
    ...
    private Drawable generateCircleDrawable(final int color) {
        ...
        drawable.setIntrinsicHeight(3);
        drawable.setIntrinsicWidth(3);
    ...
    private Drawable generateRippleDrawable(final int color) {
